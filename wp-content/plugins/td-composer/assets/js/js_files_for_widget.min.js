...
window.addSidebarWrappers=function(a){a.find(".td-main-sidebar").wrap('<div class="tdc-sidebar-content"></div>')};window.checkTdBlockWrap=function(a){a.each(function(a,b){var c=h(b);0===parseInt(c.height())?c.addClass("tdc-block-empty"):c.removeClass("tdc-block-empty")})};var b=window.tdcPostSettings.postMetaVcJsStatus,a=window.tdcPostSettings.postContent;"1"!==window.tdcPostSettings.postMetaDirtyContent&&"true"!==b||""===a||new tdcNotice.showNotice("The current content hasn't been created by TagDiv Composer!",
...
dataType:"json",data:{image_class:e,action:"tdc_ajax_get_image_id"}}).done(function(b,e,g){if("success"===e)if(a.isObject(b)&&a.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{e=c.closest(".tdc-property-wrap");g=e.find(".tdc-css-image-remove");var n=e.find(".tdc-inherit-image");g.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?n.hide():n.show();c.attr("style","background-image: url( '"+f+"') ");c.data("image_link",f);c.data("image_id",b.image_id);window.send_to_editor=
...
d=c.val();var g=1;c.hasClass("tdc-css-opacity")&&(g=.01);var n=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:h.isNumeric(d)&&(n=parseFloat(d)+g);break;case 40:h.isNumeric(d)&&(n=parseFloat(d)-g)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),h.isNumeric(d)&&(n=0<b.originalEvent.deltaY?parseFloat(d)-g:parseFloat(d)+g)}a.isNaN(n)||(1>g&&(n=n.toFixed(2)),c.val(n));tdcCssEditor._updateData(c);d=e.data("tdc-for");b={isInherited:!1};d=tdcCssEditor._getSettingsProperty(d,
...
c){var f=h(c),e=f.closest(".tdc-property-wrap"),m=e.find(".tdc-css-image-remove"),k=e.find(".tdc-inherit-image"),l={isInherited:!1},p=tdcCssEditor._getSettingsProperty("background-image",d,l);l.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);a.isUndefined(p)?(m.addClass("tdc-hidden-button"),k.hide()):("no_value"===p?m.addClass("tdc-hidden-button"):(m.removeClass("tdc-hidden-button"),f.attr("style",'background-image: url("'+p+'")')),"all"!==
tdcSidebar.currentViewportSettings.name&&k.show());f.data("image_link",p)});h(".tdc-inherit").each(function(b,c){var f=h(c),e=f.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))f.hide();else{var m=e.data("tdc-for");e={isInherited:!1};m=tdcCssEditor._getSettingsProperty(m,d,e);e.isInherited?f.hide():a.isUndefined(m)||f.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(b,c){if("undefined"===
...
b=b.find(".tdc-colorpicker-wrap");a.isUndefined(c.val())||""===c.val()||b.attr("style","background: "+c.val());d.hasClass(tdcCssEditor._INHERITED_CSS_CLASS)?""!==c.attr("placeholder")&&b.attr("style","background-color: "+tdcCssEditor._getRgba(c.attr("placeholder"))):("no_value"===c.val()&&c.val(""),tdcCssEditor._checkDefaultColor(c))})},generateEditorResponsiveContent:function(){function b(){return m={isInherited:!1}}function c(a){return"all"!==tdcSidebar.currentViewportSettings.name?'placeholder="'+
a+'"':""}function f(){return m.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function e(c,d){var e=tdcCssEditor._getSettingsProperty(c,d,b()),k="-",l="";m.isInherited&&(k=e,e="");a.isUndefined(n)||"margin-left"!==c&&"margin-right"!==c||(l=n.get("tag"),l="vc_column"===l||"vc_column_inner"===l?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+c+'" name="" type="text" value="'+e+'" class="tdc-css-box-input tdc-css-box-input-'+c+f()+l+'" title="Css '+c+'" placeholder="'+k+
'" '+tdcSidebarPanel._getParamterDataAtts(g,n)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var g=tdcCssEditor._mappedParameter,n=tdcCssEditor._model,m={isInherited:!1};var k='<div class="tdc-responsiveness">'+('<div class="'+tdcSidebarPanel._getParameterClasses(g)+'">');k=k+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+e("margin-top","");k+=e("margin-right","");k+=e("margin-bottom","");k+=e("margin-left","");k=k+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
...
('<select class="tdc-css-border-style" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},
{value:"inherit",display:"Inherit"}],l);k+="</select></div></div>";l=a.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",b()),q="";m.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+f()+'" data-tdc-for="border-color">';k=k+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,n)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+l+'" name="" type="text" '+c(q)+' value="'+p+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsProperty("border-radius","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+f()+'" data-tdc-for="border-radius">';k=k+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property">'+
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';l=tdcCssEditor._getSettingsProperty("width","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+f()+'" data-tdc-for="width">';k=k+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property">'+
('<input class="tdc-css-width" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';l=tdcCssEditor._getSettingsProperty("shadow-size","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+f()+'" data-tdc-for="shadow-size">';k=k+'<div class="tdc-property-title"><span title="Css shadow-size">Shadow size</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-size" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+="</div></div>";l=a.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",b());q="";m.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+f()+'" data-tdc-for="shadow-color">';k=k+'<div class="tdc-property-title"><span title="Css shadow-color">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,n)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+l+'" name="" type="text" '+c(q)+' value="'+p+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+f()+'" data-tdc-for="shadow-offset-h">';k=k+'<div class="tdc-property-title"><span title="Css shadow-offset-h">Shadow offset H</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-offset-h" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+f()+'" data-tdc-for="shadow-offset-v">';k=k+'<div class="tdc-property-title"><span title="Css shadow-offset-v">Shadow offset V</span></div><div class="tdc-property">'+('<input class="tdc-css-shadow-offset-v" '+
tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';l=a.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",b());q="";m.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+f()+'" data-tdc-for="background-color">';k=k+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,n)+tdcCssEditor._getDataNoValue(p)+' id="'+l+'" name="" type="text" '+c(q)+' value="'+p+'"/>');k+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",d,b());k+='<div class="tdc-property-wrap tdc-property-attach_image'+f()+'">';k=k+'<div class="tdc-property-title"><span title="Css background-image">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property">'+
('<div class="tdc-css-bg-image tdc-css-image-wrap " '+tdcSidebarPanel._getParamterDataAtts(g,n)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");k+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';l=tdcCssEditor._getSettingsProperty("background-style",d,b());k+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+f()+'" data-tdc-for="background-style">';k=k+'<div class="tdc-property-title"><span title="Css background-size & background-repeat">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-style" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],l);k+="</select></div></div>";l=tdcCssEditor._getSettingsProperty("background-position",d,b());k+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+f()+'" data-tdc-for="background-position">';k=k+'<div class="tdc-property-title"><span title="Css background-position">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-position" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",
display:"Right Bottom"}],l);k+="</select></div></div>";l=tdcCssEditor._getSettingsProperty("opacity","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+f()+'" data-tdc-for="opacity">';k=k+'<div class="tdc-property-title"><span title="Css background-image opacity">Background opacity</span></div><div class="tdc-property">'+('<input class="tdc-css-opacity" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');
k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';l=a.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",b());q="";m.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+f()+'" data-tdc-for="color-1-overlay">';k=k+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,n)+tdcCssEditor._getDataNoValue(p)+' id="'+l+'" name="" type="text" '+c(q)+' value="'+p+'"/>');k+="</div></div>";l=a.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());q="";m.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+f()+'" data-tdc-for="color-2-overlay">';k=k+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,n)+tdcCssEditor._getDataNoValue(p)+' id="'+l+'" name="" type="text" '+c(q)+' value="'+p+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsProperty("gradient-direction","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+f()+'" data-tdc-for="gradient-direction">';k=k+'<div class="tdc-property-title"><span title="Css gradient direction">Gradient direction</span></div><div class="tdc-property">'+
('<input class="tdc-css-gradient-direction" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';l=tdcCssEditor._getSettingsProperty("content-h-align",d,b());k+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+f()+'" data-tdc-for="content-h-align">';k=k+'<div class="tdc-property-title"><span title="Css content horizontal align">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-content-h-align" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],l);k+="</select></div></div>";l=tdcCssEditor._getSettingsProperty("z-index","",b());p="";m.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+f()+'" data-tdc-for="z-index">';
k=k+'<div class="tdc-property-title"><span title="Z-index">Z-index</span></div><div class="tdc-property">'+('<input class="tdc-css-z-index" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="" type="text" '+c(p)+' value="'+l+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsPropertyFromCssSettings("display",d);k+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+f()+'" data-tdc-for="display">';k=k+'<div class="tdc-property-title"><span title="Css content horizontal align">Display</span></div><div class="tdc-property">'+
('<select class="tdc-css-display" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],l);k=k+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+
('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(g,n)+' title="Clear all tab css settings">Clear CSS settings</div>');k+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){h(".tdc-inherit").each(function(b,c){var f=h(c),e=f.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))f.hide();else{var g=e.data("tdc-for");
...
typeof b&&"undefined"!==typeof c&&(b=c);return b},_generateDropdownOptions:function(b,c,d){for(var f=[],g,n=!1,m=0,k=0;k<b.length;k++)a.isUndefined(d)||d!==b[k].value||(m=k),g="",a.isUndefined(c)||c!==b[k].value||(g='selected="selected"',n=!0),f.push("<option "+g+' value="'+b[k].value+'">'+b[k].display+"</option>");n||(f[m]='<option selected="selected" value="'+b[m].value+'">'+b[m].display+"</option>");return f.join("")},_generateCssAttValue:function(b){var c={},d=b.find(".tdc-css-box-input-margin-top").val().trim(),
e=b.find(".tdc-css-box-input-margin-right").val().trim(),g=b.find(".tdc-css-box-input-margin-bottom").val().trim(),n=b.find(".tdc-css-box-input-margin-left").val().trim(),m=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),l=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),h=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),v=b.find(".tdc-css-box-input-padding-right").val().trim(),
u=b.find(".tdc-css-box-input-padding-bottom").val().trim(),r=b.find(".tdc-css-box-input-padding-left").val().trim(),t=b.find(".tdc-css-border-radius").val().trim(),x=b.find(".tdc-css-width").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),w=b.find(".tdc-css-shadow-offset-h").val().trim(),A=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==d&&(c["margin-top"]=
d);""!==e&&(c["margin-right"]=e);""!==g&&(c["margin-bottom"]=g);""!==n&&(c["margin-left"]=n);""!==m&&(c["border-top-width"]=m);""!==k&&(c["border-right-width"]=k);""!==l&&(c["border-bottom-width"]=l);""!==h&&(c["border-left-width"]=h);""!==q&&(c["padding-top"]=q);""!==v&&(c["padding-right"]=v);""!==u&&(c["padding-bottom"]=u);""!==r&&(c["padding-left"]=r);d=b.find(".tdc-css-border-style");e=d.val().trim();""===e||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=
e);d=b.find(".tdc-css-border-color");e=d.val().trim();""!==e?c["border-color"]=e:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==t&&(c["border-radius"]=t);""!==x&&(c.width=x);""!==z&&(c["shadow-size"]=z);t=b.find(".tdc-css-shadow-color");x=t.val().trim();""!==x?c["shadow-color"]=x:(t=t.data("no_value"),a.isUndefined(t)||1!==t||(c["shadow-color"]="no_value"));""!==w&&(c["shadow-offset-h"]=w);""!==A&&(c["shadow-offset-v"]=A);w=b.find(".tdc-css-bg-color");A=w.val().trim();
...
d=b.closest(".tdc-property").find('input[type="radio"]:checked');var e=d.data("default_value"),g=b.val().trim();""!==g||_.isUndefined(e)||""===e||(g=e,b.val(g));c.val(g);d.data("last_value",g);c=c.get(0)}else if("radio"===b.attr("type")){c=b.closest(".tdc-property").find('input[type="range"]');d=b.closest(".tdc-property").find('input[type="text"]');b.closest(".tdc-property").find('input[type="radio"]:checked');g=b.data("last_value");e=b.data("default_value");var n=b.data("unit");b=c.data("min_"+n);
var m=c.data("max_"+n);n=c.data("step_"+n);c.get(0).min=b;c.get(0).max=m;c.get(0).step=n;""===g?(d.val(e),c.val(e)):(d.val(g),c.val(g));c=c.get(0)}e="";d=jQuery(c).parent().find('input[type="radio"]:checked');d.length&&(e=jQuery(d[0]).data("unit_value"));"focusin"===a.type?c.oldValue=c.value+e:(a=c.value+e,e=tdcIFrameData.getModel(jQuery(c).data("model_id")),tdcSidebarController.onUpdate(e,jQuery(c).data("param_name"),c.oldValue,_.escape(a)),c.oldValue=a)});a.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),e=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),n=d.get(0),m="",k=e.data("default_value"),l=tdcIFrameData.getModel(d.data("model_id")),h=d.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[l.attributes.tag],v=l="";var u=[];for(var r=0;r<q.params.length;r++)if(h===q.params[r].param_name){r=q.params[r].tdc_values;for(var t in r)r.hasOwnProperty(t)&&(u.push(r[t].unit),
""===l||""===v)&&(l=r[t].value,v=r[t].unit);break}e.length&&(m=e.data("unit_value"));if("range"===b.attr("type"))u=d.val(),g.val(u),e.data("last_value",u),g.val(u),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),u+m,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");u=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
u||_.isUndefined(k)||""===k?(d.val(u),e.data("last_value",u),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),u+m,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+h,tdcSidebar.currentViewportSettings.name)),d.data("range_value",l),d.data("range_unit",v),d.val(l),m=c.find('input[type="radio"][data-unit_value="'+v+'"]'),q=m.data("unit"),t=d.data("min_"+q),e=d.data("max_"+q),q=d.data("step_"+q),m.prop("checked",
!0),n.min=t,n.max=e,n.step=q,n.value=l,m.data("last_value",l),g.val(l));else if(""===u)if(m=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof m)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+h,tdcSidebar.currentViewportSettings.name)),d.data("range_value",l),d.data("range_unit",v),d.val(l),m=c.find('input[type="radio"][data-unit_value="'+v+'"]'),q=m.data("unit"),t=d.data("min_"+q),e=d.data("max_"+q),q=d.data("step_"+q),m.prop("checked",
!0),n.min=t,n.max=e,n.step=q,n.value=l,m.data("last_value",l),g.val(l),c.addClass("tdc-css-inherited");else for(r=0;r<q.params.length;r++){if(h===q.params[r].param_name){u=[];g=[];r=q.params[r].tdc_values;for(t in r)r.hasOwnProperty(t)&&u.push(r[t].unit);for(r=0;r<u.length&&!(g=m.split(u[r]),1<g.length);r++);g.length&&(l=g[0],v=u[r],d.data("range_value",l),d.data("range_unit",v),m=c.find('input[type="radio"][data-unit_value="'+v+'"]'),q=m.data("unit"),t=d.data("min_"+q),e=d.data("max_"+q),q=d.data("step_"+
q),m.prop("checked",!0),n.min=t,n.max=e,n.step=q,n.value=l,m.data("last_value",l),c.find('input[type="text"]').val(l));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+h,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(u),e.data("last_value",u),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),u+m,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
h=e.data("last_value");q=e.data("unit");t=d.data("min_"+q);e=d.data("max_"+q);q=d.data("step_"+q);n.min=t;n.max=e;n.step=q;""===h?(g.val(k),d.val(k),u=k):(g.val(h),d.val(h),u=h);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),u+m,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}m="";c=jQuery(n).parent().find('input[type="radio"]:checked');c.length&&(m=jQuery(c[0]).data("unit_value"));"focusin"===a.type?n.oldValue=n.value+m:(c=jQuery(n),
a=c.data("data-to-save"),l=tdcIFrameData.getModel(c.data("model_id")),n.oldValue!==a&&(tdcSidebarController.onUpdate(l,jQuery(n).data("param_name"),n.oldValue,_.escape(a)),n.oldValue=a))});a.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(a){if("focusin"===a.type)this.oldValue=this.value;else{a=jQuery(this);var b=a.val();a.is(":checked")||(b="");var c=tdcIFrameData.getModel(a.data("model_id"));tdcSidebarController.onUpdate(c,a.data("param_name"),this.oldValue,b);this.oldValue=
...
b)});a.on("click",".tdc-colorpicker-wrap",function(a){tdcSidebarPanel.showHideTdcPalette.call(this,a)});a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),e=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),n=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(d.hide(),b.after(d)):d=tdcSidebar.buildGradient();e.length?e.get(0).contains(a.target)||
jQuery(a.target).hasClass("tdc-colorpicker-wrap")||(e.hide(),b.after(e),e.find("input.wp-color-picker").tdPaletteColorPicker("save_color")):e=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!n.length||n.get(0).contains(a.target)||jQuery(".tdc-preset-values").get(0).contains(a.target)?n.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(a.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),
$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):n.is(":visible")&&(n.hide(),b=jQuery(a.target),jQuery(".tdc-top-buttons").get(0).contains(a.target)||b.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(a.target)||b.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(a.target)||b.hasClass("tdc-current-element-head")?
jQuery(".tdc-current-element-head").get(0).contains(a.target)||b.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0),jQuery(".tdc-current-element-head").trigger(a)):tdcSidebarPanel.clearPanel():setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
var a=jQuery(this),c=a.data("model_id"),d=tdcIFrameData.getModel(c),e=d.get("attrs");e=_.clone(e);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),n="",m=0;m<g.length;m++){var k=a.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[m]+":first");if(k.length){var l=k.find('[data-model_id="'+c+'"]');l.length&&(l.val(""),l.data("responsive",""),k.removeClass("tdc-css-inherited"),n=k.find(".tdc-inherit"),n.length&&n.hide(),n=l.data("placeholder"),
"undefined"!==typeof n&&l.attr("placeholder",n),n=l.data("param_name"),delete e[n],l=l.attr("name"),tdcSidebarPanel.deleteResponsiveValues(l))}}d.set("attrs",e);tdcSidebarController.onUpdate(d,n,"","")}})});a.on("click",".tdc-sidebar-font-save",function(a){a=jQuery(this);var b=a.data("model_id");b=tdcIFrameData.getModel(b).get("attrs");var c=a.data("param_name").replace("font_settings",""),d="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),e={};
...
if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(e);a=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var n=window.tdcAdminSettings.tdcSavings.recentFonts[g],m=a[n];_.isUndefined(m)||jQuery('<div class="tdc-recent-font-settings" data-value="'+n+'" data-model_id="'+c+'" data-param_name="'+f+'"><span class="tdc-font-name">'+
m+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(e)}}b.after(e);e.toggle()}});a.on("click",".tdc-font-delete",function(a){a.stopImmediatePropagation();var b=jQuery(this).closest(".tdc-font-settings");a=b.data("name");a=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:a});window.tdcAdminSettings.tdcSavings.fonts.splice(a,1);tdcUtil.updateTdcSavings(this,function(){b.remove()})});a.on("click",".tdc-recent-font-delete",function(a){a.stopImmediatePropagation();var b=jQuery(this).closest(".tdc-recent-font-settings");
...
d=tdcIFrameData.getModel(b);b={error:h};_.isUndefined(d)||tdcIFrameData._checkModelData(d,b)}var c=d.get("tag");b=d.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var f={},e={};for(g in b)0===g.indexOf("tds_")&&(f[g]=b[g]);var g=window.tdcAdminSettings.mappedShortcodes[c].params;for(c=0;c<g.length;c++){var n=!1,m=g[c];if(0===m.param_name.indexOf("tds_")){for(var k in f)if(m.param_name===k){e[k]=f[k];n=!0;break}n||(e[m.param_name]="")}}for(k in f)switch(g=k.split("-"),g.length){case 2:if(!_.has(e,
k)){f=g[0];g=!1;for(var l in e)if(f===e[l]&&1===l.split("-").length){g=!0;break}if(!g){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){var q=p;break}_.has(e,q)&&""===e[q]&&window.tdcAdminSettings.globalStyle[q]===f&&(g=!0)}g||delete b[k]}break;case 3:f=g[0];c=g[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){q=p;break}g=!1;for(l in e)if(f===e[l]&&l===q+"-"+c){g=!0;break}g||_.has(e,q+
"-"+c)&&""===e[q+"-"+c]&&window.tdcAdminSettings.globalStyle[q]===f&&(g=!0);g||delete b[k]}return b}},showHideTdcPalette:function(a){a=jQuery("#tdc-palette");var d=jQuery(this).closest(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();d.next("#tdc-palette").length?(a.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),d.after(a),a.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var a=jQuery("#tdc-palette"),d=a.prev(".tdc-property-wrap");a.length||
...
a.cid||!_.isUndefined(d)&&(_.isUndefined(d)||!0===d)){var b=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=a;for(var c=[],f=0;f<b.params.length;f++){var e=tdcSidebarPanel._defaultGroupName;_.isEmpty(b.params[f].group)||(e=b.params[f].group);c.push(e)}c=_.uniq(c);var g=e="",n=tdcSidebar.getCurrentTabId(),m,k;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var l=k=m="";for(f=
0;f<c.length;f++){g=tdcSidebarPanel._fixGroupName(c[f]);var h=tdcUtil.makeSafeForCSS(g);0===f?(m='<a href="#" data-tab-id="td-tab-'+h+'" class="tdc-tab-active" title="'+g+' settings">'+g+"</a>",k='<a href="#" data-tab-id="td-tab-'+h+'" title="'+g+' settings">'+g+"</a>"):_.isUndefined(n)||n!=="td-tab-"+h?l+='<a href="#" data-tab-id="td-tab-'+h+'" title="'+g+' settings">'+g+"</a>":(m=k,l+='<a href="#" data-tab-id="td-tab-'+h+'" class="tdc-tab-active" title="'+g+' settings">'+g+"</a>")}g=h=k=f="";switch(tdcSidebar.currentViewportSettings.name){case "all":f=
"selected";break;case "landscape":k="selected";break;case "portrait":h="selected";break;case "phone":g="selected"}e=e+(m+l)+'</div><div class="tdc-tab-responsive">';e+='<div class="tdc-responsive-buttons">';e+='<div class="tdc-responsive-all '+f+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(e+='<div class="tdc-responsive-tablet-landscape '+k+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');
e+='<div class="tdc-responsive-tablet-portrait '+h+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';e+='<div class="tdc-responsive-phone '+g+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';e+="</div>";e+="</div></div>";e+='<div class="tdc-sidebar-sticky-a"></div>';e+='<div class="tdc-sidebar-sticky-b"></div>';e+='<div class="tdc-tab-content-wrap">';l=k=m="";for(f=0;f<c.length;f++){g=tdcSidebarPanel._fixGroupName(c[f]);h=tdcUtil.makeSafeForCSS(g);
g="tdc-tab-no-design";var q=a.get("tag");"css"===h&&(g="tdc-tab-design");0===f?(m='<div class="tdc-tab-content tdc-tab-content-visible '+g+'" id="td-tab-'+h+'">',k='<div class="tdc-tab-content '+g+'" id="td-tab-'+h+'">',h=window.tdcAdminSettings.mappedShortcodes[q].tdc_start_values,a.unset("presetValues"),_.isUndefined(h)||(h=JSON.parse(window.atob(h)),_.isArray(h)&&1<h.length&&a.set("presetValues",h)),a.has("presetValues")&&(h=a.get("presetValues"),l+=tdcSidebarPanel._addPresetValuesSelector(h,a))):
_.isUndefined(n)||n!=="td-tab-"+h?l+='<div class="tdc-tab-content '+g+'" id="td-tab-'+h+'">':(m=k,l+='<div class="tdc-tab-content tdc-tab-content-visible '+g+'" id="td-tab-'+h+'">');l+=tdcSidebarPanel._bindGroupAndGetHtml(c[f],b,a);h=' data-model_id="'+a.cid+'" ';"vc_row"===a.attributes.tag?(l+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(l+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+h+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>'),
l+="</div>"):"vc_row_inner"===a.attributes.tag?(l+='<div class="tdc-sidebar-row-buttons">',l+="</div>"):"vc_column"!==a.attributes.tag&&"vc_column_inner"!==a.attributes.tag&&(l+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(l+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+h+' title="Get the current styles\' settings">CONSOLE: style presets</div>'),l+="</div>");l+="</div>"}e=e+(m+l)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(e);
...
b.parent().find("input[value=13_23] + label").addClass("tdc-block-col");b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":b.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),b.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(a,d,b){var c=
"",f=b.get("attrs");if("tdc_zone"===b.get("tag"))var e=f.type;for(var g=0;g<d.params.length;g++){var n=d.params[g].param_name,h=d.params[g].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(d.params[g].group)||d.params[g].group===a){if(!_.isUndefined(e)&&(!_.isUndefined(d.params[g].zone_group)&&e!==d.params[g].zone_group||"type"===n))continue;c+=tdcSidebarPanel._bindParamAndGetHtml(d.params[g],b)}if("block_template_id"===n){h=f.block_template_id;_.isEmpty(h)&&(h=window.tdcAdminSettings.globalBlockTemplate);
n=window.tdcAdminSettings.mappedBlockTemplates;for(var k=0;k<n[h].params.length;k++)if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(n[h].params[k].group)||n[h].params[k].group===a)c+=tdcSidebarPanel._bindParamAndGetHtml(n[h].params[k],b)}else if(0===n.indexOf("tds_")){var l=n.split("-");k=l[0];var p;2===l.length?p=l[1]:2<l.length&&new tdcNotice.notice('Param "'+n+'" must have up to at most one "-" separator ',!0,!1);n=f[n];_.isEmpty(n)&&(n=window.tdcAdminSettings.globalStyle[k]);l=window.tdcAdminSettings.settingsStyle[k];
for(k=0;k<l[n].params.length;k++)if(h==a||_.isUndefined(h)&&a===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(l[n].params[k]));q.param_name=n+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);c+=tdcSidebarPanel._bindParamAndGetHtml(q,b)}}}return c},_bindParamAndGetHtml:function(a,d){switch(a.type){case "colorpicker":return tdcSidebarPanel.addColorpicker(a,d);case "gradient":return tdcSidebarPanel.addGradient(a,d);case "dropdown":return tdcSidebarPanel.addDropDown(a,d);
...
d);case "attach_image":return tdcSidebarPanel.addUploadImage(a,d);case "textfield":return tdcSidebarPanel.addTextField(a,d);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(a,d);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(a,d);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(a,d);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(a,d);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(a,
d);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(a,d);case "font_header":return tdcSidebarPanel.addFontHeader(a,d);case "font_title":return tdcSidebarPanel.addFontTitle(a,d);case "font_reset":return tdcSidebarPanel.addFontReset(a,d);case "font_save":return tdcSidebarPanel.addFontSave(a,d);case "font_load":return tdcSidebarPanel.addFontLoad(a,d);case "font_settings":return tdcSidebarPanel.addFontSettings(a,d);case "shadow_header":return tdcSidebarPanel.addShadowHeader(a,d);
case "shadow_title":return tdcSidebarPanel.addShadowTitle(a,d);case "clearfix":return tdcSidebarPanel.addClearfix(a,d);case "tdc_hidden_field":return"";default:return a.param_name+" - "+a.type+"<br>"}},_deletePanel:function(){tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=h;tdcSidebarPanel.saveTdcPalette();jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();jQuery(".tdc-inspector .tdc-tabs-wrapper").empty();jQuery(".tdc-inspector-wrap").removeClass("tdc-inspector-active");
jQuery(".tdc-empty-sidebar").show();tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible");tdcSidebar.$_currentElementHead.removeClass("tdc-current-element-siblings-button-on");delete window.tdcResponsiveValues;tdcSidebar.hideWpeditor()},_getParameterClasses:function(a){var d="tdc-property-wrap tdc-property-"+a.type;d+=" tdc-property-"+a.param_name;_.isUndefined(a["class"])||(d+=" "+a["class"]);return d},_getParameterCurrentValue:function(a,d){var b=d.get("attrs");
return _.isUndefined(b[a.param_name])?"dropdown"===a.type||_.isUndefined(a.value)?"":a.value:b[a.param_name]},_getParameterDomName:function(a){return"tdc-param-"+a.param_name},_getParamterDataAtts:function(a,d){var b="";if("undefined"===typeof d)return b;b+=' data-model_id="'+d.cid+'"';"undefined"!==typeof a&&(b+=' data-param_name="'+a.param_name+'"');return b},_fixGroupName:function(a){switch(a){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return a},
clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(a,d){var b='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+('<ul class="tdc-preset-values-list" data-model_id="'+d.cid+'">');for(var c=1;c<a.length;c++){var f="";_.isUndefined(a[c].tdc_preset_individual)||(f=
'data-individual="1"');var e="";_.isUndefined(a[c].tdc_preset_class)||(e=' class="'+a[c].tdc_preset_class+'"');b+="<li "+f+" "+e+' data-values="'+window.btoa(JSON.stringify(a[c]))+'">'+a[c].tdc_preset_name+"</li>"}b+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return b},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});
...
_.isUndefined(e)||_.map(window.tdcAdminSettings.mappedBlockTemplates[e].params,function(c,e){c.param_name===b&&(d=!0,f[b]=a)})}d||0!==b.indexOf("tds_")||(f[b]=a)}),c.set("attrs",f));tdcSidebarController.onUpdate(c)})},addColorpicker:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+
('<div class="tdc-colorpicker-wrap" title="'+a.heading+'">');c=c+"</div>"+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');c+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return c},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();
...
("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');c+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return c},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var a=
...
(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(c=!0);var f="",e="",g=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&g.length<=parseInt(a.tdc_min_options))return f;for(var h=0;h<g.length;h++){var m=!1,k="",l=g[h],p=String(tdcSidebarPanel._getParameterCurrentValue(a,d)),q=String(a.value[g[h]]);_.isObject(a.value[g[h]])&&(m=!0,q=_.values(a.value[g[h]])[0],l=_.keys(a.value[g[h]])[0]);if(b||c){0===h&&""===p&&(p=q);p===q&&(k=" checked ");p=_.uniqueId();var v=q;if("vc_row"===d.attributes.tag||
"vc_row_inner"===d.attributes.tag)v="col_"+v;e+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' id="'+p+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+k+' value="'+q+'">';b?(k="",m&&(k="tdc-standard-value"),e+='<label class="tdc-property-input-radio-label '+k+'" for="'+p+'" title="'+l+'"><div class="'+v+'"></div></label>'):e+='<label class="tdc-property-input-radio-label" for="'+p+'" title="'+l+'">'+q+"</label>"}else p===q&&(k=' selected="selected" '),
e+="<option "+k+' value="'+q+'">'+l+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');f+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+g+">"+a.heading+"</span></div>";f+='<div class="tdc-property">';b||c?f+=e:(f+="<select "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'">',f=f+e+"</select>");return f+"</div></div>"},addDropDownResponsive:function(a,d){var b=
!1,c=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(c=!0);var f="",e="",g=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&g.length<=parseInt(a.tdc_min_options))return f;var h=' data-responsive="" ',m=String(tdcSidebarPanel._getParameterCurrentValue(a,d));try{var k=JSON.parse(window.atob(m));h=' data-responsive="'+m+'" ';"undefined"!==typeof k[tdcSidebar.currentViewportSettings.name]&&(m=k[tdcSidebar.currentViewportSettings.name])}catch(t){}for(k=
0;k<g.length;k++){var l=!1,p="",q=g[k],v=String(a.value[g[k]]);_.isObject(a.value[g[k]])&&(l=!0,v=_.values(a.value[g[k]])[0],q=_.keys(a.value[g[k]])[0]);if(b||c){0===k&&""===m&&(m=v);m===v&&(p=" checked ");var u=_.uniqueId(),r=v;if("vc_row"===d.attributes.tag||"vc_row_inner"===d.attributes.tag)r="col_"+r;e+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' id="'+u+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+' value="'+v+'">';b?(p="",
l&&(p="tdc-standard-value"),e+='<label class="tdc-property-input-radio-label '+p+'" for="'+u+'" title="'+q+'"><div class="'+r+'"></div></label>'):e+='<label class="tdc-property-input-radio-label" for="'+u+'" title="'+q+'">'+v+"</label>"}else m===v&&(p=' selected="selected" '),e+="<option "+p+' value="'+v+'">'+q+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');f+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+
g+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';f+='<div class="tdc-property">';b||c?f+=e:(f+="<select "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+h+g+">",f=f+e+"</select>");return f+"</div></div>"},addCheckBox:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c="";""!==tdcSidebarPanel._getParameterCurrentValue(a,
d)&&(c=" checked ");var f='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";f=f+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+c+"/>");return f+"</div></div>"},addCheckBoxResponsive:function(a,d){var b="",c=' data-responsive="" ',f=String(tdcSidebarPanel._getParameterCurrentValue(a,d));try{var e=JSON.parse(window.atob(f));
c=' data-responsive="'+f+'" ';"undefined"!==typeof e[tdcSidebar.currentViewportSettings.name]&&(f=e[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==f&&(b=" checked ");e="";_.has(a,"description")&&""!==a.description&&(e=' title="'+a.description+'" ');f='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+e+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,d)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,d));var m='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';m+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";m=m+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+f+'" data-max="'+
c+'" data-step="'+e+'" min="'+f+'" max="'+c+'" step="'+e+'" value="'+h+'" />');return m=m+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" value="'+h+'"/>')+"</div></div>"},addRangeResponsive:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c="";_.has(a,"range_max")&&""!==a.range_max&&(c=a.range_max);var f="";_.has(a,"range_min")&&""!==a.range_min&&(f=a.range_min);var e="";_.has(a,"range_step")&&""!==a.range_step&&(e=a.range_step);
var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,d)&&tdcSidebarPanel._getParameterCurrentValue(a,d);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var m=' data-responsive="" ',k=tdcSidebarPanel._getParameterCurrentValue(a,d);try{var l=JSON.parse(window.atob(k));m=' data-responsive="'+k+'" ';k="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(p){}l=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';l+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";l=l+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+k+'" data-min="'+f+'" data-max="'+c+'" data-step="'+e+'" min="'+f+'" max="'+c+'" step="'+e+'" value="'+k+'" '+m+" />");return l=l+('<input type="text" class="tdc_range_value" data-default_value="'+
g+'" '+h+' value="'+k+'"/>')+"</div></div>"},addRangeMultiple:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c=a.tdc_values,f=tdcSidebarPanel._getParameterCurrentValue(a,d),e="",g="",h=[],m="",k="",l="",p="",q="",v="",u="",r;for(r in c)c.hasOwnProperty(r)&&(h.push(c[r].unit),""===k||""===m)&&(p=c[r].unit,k=' data-range_unit="'+p+'" ',l=c[r].value,m=' data-range_value="'+l+'" ',q=c[r].range_min,v=c[r].range_max,u=c[r].range_step);if(""!==f){for(var t=
[],x=0;x<h.length&&!(t=f.split(h[x]),1<t.length);x++);t.length&&(p=h[x],k=' data-range_unit="'+p+'" ',l=t[0],m=' data-range_value="'+l+'" ')}for(r in c)c.hasOwnProperty(r)&&(f=_.uniqueId(),e+=" data-value_"+r+'="'+c[r].value+'" ',e+=" data-min_"+r+'="'+c[r].range_min+'" ',e+=" data-max_"+r+'="'+c[r].range_max+'" ',e+=" data-step_"+r+'="'+c[r].range_step+'" ',h=c[r].value,t="",c[r].unit===p&&(h=l,q=c[r].range_min,v=c[r].range_max,u=c[r].range_step,t="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+
'_unit" data-unit="'+r+'" data-unit_value="'+c[r].unit+'" type="radio" id="'+f+'" '+t+' data-default_value="'+c[r].value+'" data-last_value="'+h+'"/>',g+='<label for="'+f+'">'+c[r].unit+"</label>");c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+
m+" "+k+" "+e+' min="'+q+'" max="'+v+'" step="'+u+'" value="'+l+'"/>');c=c+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+l+'"/>');c+="</div>";c+="</div>";return c+="</div>"},addRangeMultipleResponsive:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c=a.tdc_values,f=tdcSidebarPanel._getParameterCurrentValue(a,d),e="",g="",h=[],m=' data-responsive="" ',
k="",l="",p="",q="",v="",u="",r="",t;for(t in c)c.hasOwnProperty(t)&&(h.push(c[t].unit),""===l||""===k)&&(q=c[t].unit,l=' data-range_unit="'+q+'" ',p=c[t].value,k=' data-range_value="'+p+'" ',v=c[t].range_min,u=c[t].range_max,r=c[t].range_step);if(""!==f){var x=f;try{var z=JSON.parse(window.atob(f));m=' data-responsive="'+f+'" ';x="undefined"===typeof z[tdcSidebar.currentViewportSettings.name]?"":z[tdcSidebar.currentViewportSettings.name]}catch(w){}if(""!==x){f=[];for(z=0;z<h.length&&!(f=x.split(h[z]),
1<f.length);z++);f.length&&(q=h[z],l=' data-range_unit="'+q+'" ',p=f[0],k=' data-range_value="'+p+'" ')}}for(t in c)c.hasOwnProperty(t)&&(h=_.uniqueId(),e+=" data-value_"+t+'="'+c[t].value+'" ',e+=" data-min_"+t+'="'+c[t].range_min+'" ',e+=" data-max_"+t+'="'+c[t].range_max+'" ',e+=" data-step_"+t+'="'+c[t].range_step+'" ',x=c[t].value,f="",c[t].unit===q&&(x=p,v=c[t].range_min,u=c[t].range_max,r=c[t].range_step,f="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+
t+'" data-unit_value="'+c[t].unit+'" type="radio" id="'+h+'" '+f+' data-default_value="'+c[t].value+'" data-last_value="'+x+'"/>',g+='<label for="'+h+'">'+c[t].unit+"</label>");c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" type="range" '+k+" "+l+" "+e+" "+m+' min="'+v+'" max="'+u+'" step="'+r+'" value="'+p+'"/>');c=c+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+p+'"/>');c+="</div>";c+="</div>";return c+="</div>"},addIconSelector:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+
b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<div class="tdc-icon-wrap tdc-no-icon-selected" '+tdcSidebarPanel._getParamterDataAtts(a,d)+">");c+='</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(b,c){var e=jQuery(c);if(a.param_name===e.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(a,d);""!==f&&(e.html('<i class="'+f+'"></i>'),
...
b,c){})}})});return c},addTextField:function(a,d){var b="",c="";if(_.has(a,"description")&&""!==a.description){var f=jQuery("<div>"+a.description+"</div>");a.description===f.text()?b=' title="'+a.description+'" ':c='<div class="tdc-description">'+a.description+"</div>"}f="";_.has(a,"placeholder")&&""!==a.placeholder&&(f=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span'+
b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" '+f+' value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');return e=e+c+"</div></div>"},addTextFieldResponsive:function(a,d){var b="",c="";if(_.has(a,"description")&&""!==a.description){var f=jQuery("<div>"+a.description+"</div>");a.description===f.text()?b=' title="'+a.description+'" ':c='<div class="tdc-description">'+
a.description+"</div>"}f="";_.has(a,"placeholder")&&""!==a.placeholder&&(f=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var e=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(a,d);try{var h=JSON.parse(window.atob(g));e=' data-responsive="'+g+'" ';g="undefined"===typeof h[tdcSidebar.currentViewportSettings.name]?"":h[tdcSidebar.currentViewportSettings.name]}catch(m){}h='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';
h+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";h=h+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+g+'" '+f+e+b+"/>");return h=h+c+"</div></div>"},addTextAreaHtml:function(a,d){_.has(a,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+d.cid+'" data-mapped_parameter_name="'+a.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(a,
...
tdcIFrameData.getModel(a.data("model_id"));var e=a.data("param_name"),g=window.tdcAdminSettings.mappedShortcodes[c.attributes.tag];c=[];for(var h=f="",m=0;m<g.params.length;m++)if(e===g.params[m].param_name){e=g.params[m].tdc_values;for(var k in e)e.hasOwnProperty(k)&&(c.push(e[k].unit),""===f||""===h)&&(f=e[k].value,h=e[k].unit);break}_.isUndefined(d)?(d=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(d)&&(a.data("range_value",f),a.data("range_unit",h),a.val(f),k=b.find('input[type="radio"][data-unit_value="'+
h+'"]'),m=k.data("unit"),e=a.data("min_"+m),h=a.data("max_"+m),m=a.data("step_"+m),g=a.get(0),k.prop("checked",!0),g.min=e,g.max=h,g.step=m,g.value=f,k.data("last_value",f),b.find('input[type="text"]').val(f)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(d)){f=[];for(m=0;m<c.length&&!(f=d.split(c[m]),1<f.length);m++);f.length&&(f=f[0],h=c[m],a.data("range_value",f),a.data("range_unit",
h),a.val(f),k=b.find('input[type="radio"][data-unit_value="'+h+'"]'),m=k.data("unit"),e=a.data("min_"+m),h=a.data("max_"+m),m=a.data("step_"+m),g=a.get(0),k.prop("checked",!0),g.min=e,g.max=h,g.step=m,g.value=f,k.data("last_value",f),b.find('input[type="text"]').val(f))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=a.toString().split("_");var d;a.forEach(function(a,b){if(""!==a)if(_.isUndefined(d))d=tdcIFrameData.tdcTopCollection.at(a);else{var c=d.get("childCollection");!_.isUndefined(c)&&
