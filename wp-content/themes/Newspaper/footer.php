    ...
    <div class="td-main-content-wrap td-footer-instagram-container td-container-wrap <?php echo td_util::get_option('td_full_footer_instagram'); ?>">
        ...
        <div class="td-instagram-user">
            <h4 class="td-footer-instagram-title">
                ...
                <a class="td-footer-instagram-user-link" href="https://www.instagram.com/<?php echo esc_url( $tds_footer_instagram_id ) ?>" target="_blank">@<?php printf( '%1$s', $tds_footer_instagram_id ) ?></a>
            </h4>
        </div>
